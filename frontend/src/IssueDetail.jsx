...
const IssueDetail = () => {
  ...
  const handleUpvoteClick = async () => {
    ...
    try {
      ...
      // Safely re-sync with the server's response
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
        ...
        // On success, you might re-fetch comments to get server-generated IDs.
        // For now, this optimistic update is sufficient.
    } catch (err) {
