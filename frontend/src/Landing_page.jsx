...
const CameraIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-10 w-10 mb-4 text-green-600"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"></path><circle cx="12" cy="13" r="3"></circle></svg>
);

const SendIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-10 w-10 mb-4 text-green-600"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
);

const CheckCircleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-10 w-10 mb-4 text-green-600"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
);
...
export default function App() {
  ...
  // Placeholder data for recent issues. In a real app, this would come from an API call with Axios.
  const issues = [
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
      ...
      <header className="bg-white/80 backdrop-blur-lg shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
             <img src="https://www.jharkhand.gov.in/includes/assets/images/logo.png" alt="Jharkhand Gov Logo" className="h-10"/>
            <a href="#" className="text-xl font-bold text-gray-800 hover:text-green-700 transition-colors">
              Civic Connect
            </a>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#" className="text-gray-600 hover:text-green-700 transition-colors">Track Status</a>
            <button className="bg-green-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-md">
              User Login
            </button>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <nav className="flex flex-col items-center space-y-4 py-4">
              ...
              <a href="#" className="text-gray-600 hover:text-green-700 transition-colors">Report Issue</a>
              <a href="#" className="text-gray-600 hover:text-green-700 transition-colors">Track Status</a>
              <button className="bg-green-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-green-700 transition-all duration-300 w-auto">
                User Login
              </button>
            </nav>
          </div>
      ...
      <main>
        {/* --- Hero Section --- */}
        <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white px-6" style={{backgroundImage: "url('https://placehold.co/1920x1080/2c3e50/ffffff?text=Empowering+Jharkhand+Communities')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <button className="bg-yellow-400 text-gray-900 font-bold py-3 px-8 text-lg rounded-full hover:bg-yellow-500 transition-all duration-300 transform hover:scale-110 shadow-xl">
              Report an Issue Now
            </button>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* This is where you would map over data fetched with Axios */}
              {issues.map((issue) => (
             ...
             <div className="text-center mt-12">
                <button className="bg-transparent border-2 border-green-600 text-green-600 font-bold py-2 px-6 rounded-lg hover:bg-green-600 hover:text-white transition-colors duration-300">
                    View More Reports
                </button>
            </div>
          </div>
